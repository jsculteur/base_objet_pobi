                ...
                <?php if(isset($_SESSION["pseudo"]))
                    echo
                        ...
                        '<div class="dropdown-menu" aria-labelledby="navbarDropdown">' . 
                            '<form class="form-nav" method="post" action="#" name="form_logout">' . 
                                '<button name="logout" value="Déconnexion" type="submit" class="btn btn-sm btn-danger btn-nav"><i class="fa fa-power-off"></i> Déconnexion</button>' . 
                            '</form>' . 
                        '</div>'
                    ;
                ?>
